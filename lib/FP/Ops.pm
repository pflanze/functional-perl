...
sub binary_operator {
    @_ == 1 or fp_croak_arity 1;
    my ($code) = @_;
    eval 'sub  {     @_ == 2  or fp_croak_arity 2; $_[0] ' . $code . ' $_[1] }'
...
sub unary_operator {
    @_ == 1 or fp_croak_arity 1;
    my ($code) = @_;
    eval 'sub { @_ == 1  or fp_croak_arity 1; ' . $code . ' $_[0] }'
...
sub make_regex_substitute {
    ...
    sub {
        ...
        goto $subst_coderef if UNIVERSAL::isa($_[0], "CODE");
        @_ >= 2
            or die "$name: need at least 2 arguments"
